...
for i in range(90,110):
    ...
    accu_his.append(accu)
    print("real:",y1[i],' pred:',pred,' accu:',accu,'\n')

total_accu=tf.reduce_mean(tf.cast(accu_his,dtype=tf.float32))
print('total accuracy:',sess.run(total_accu))

print(np.sum(accu_his))